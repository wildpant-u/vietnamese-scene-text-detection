...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default = './PaddleOCR/inference/SAST/')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./PaddleOCR/inference/SRN/')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./PaddleOCR/ppocr/utils/vn_dict.txt")
